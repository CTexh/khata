...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Reminder emails are sent through Google's Gmail to the address saved in your profile: subscriptions that are due, Udhar Khata reach-out dates and a monthly summary. They only go out if you save an email address, and you can turn them off, or pick only the ones you want, at any time in Settings.",

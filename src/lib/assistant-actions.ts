...
Mera Khata: tap the round + button to log an expense (amount, paid to, category, note, date and time). Categories fill in automatically from the payee. Month / Year switch with arrows to move between periods. The expenses for the period come first, under a row of category pills - tap one to filter the list, "All" to clear it, "+N more" for the rest. The search button searches amount, note, vendor or category. The breakdown of where the money went is on Home. Tap any expense to see it, edit it or delete it. Expenses without a category show a prompt to sort them. The ... menu has Manage categories (add, rename, delete, keywords that auto-match), Re-categorise (preview and apply category fixes) and Download Excel.
